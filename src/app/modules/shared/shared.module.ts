...
import {MyDialogExceptionComponent} from './dialogs/my-dialog-exception/my-dialog-exception.component';
import {MyDialogStockQuantityComponent} from './dialogs/my-dialog-stock-quantity/my-dialog-stock-quantity.component';
...
@NgModule({
  declarations: [
    ...
    MyDialogExceptionComponent,
    MyDialogStockQuantityComponent,
